...
;// CONCATENATED MODULE: ./src/store/reducers/data-reducer.ts
...
;// CONCATENATED MODULE: ./src/store/reducers/state-reducer.ts
var state_reducer_assign = (undefined && undefined.__assign) || function () {
    state_reducer_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return state_reducer_assign.apply(this, arguments);
};


var state_reducer_initialState = {
    appStatus: AppStatus.LOADING,
};
var stateReducer = function (state, action) {
    if (state === void 0) { state = state_reducer_initialState; }
    switch (action.type) {
        case ActionType.CHANGE_APP_STATUS:
            return state_reducer_assign(state_reducer_assign({}, state), { appStatus: action.payload });
        default:
            return state;
    }
};

;// CONCATENATED MODULE: ./src/store/reducers/view-reducer.ts
var view_reducer_assign = (undefined && undefined.__assign) || function () {
    view_reducer_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return view_reducer_assign.apply(this, arguments);
};

var view_reducer_initialState = {
    pagesCount: null,
};
var viewReducer = function (state, action) {
    if (state === void 0) { state = view_reducer_initialState; }
    switch (action.type) {
        case ActionType.UPDATE_PAGES_COUNT:
            return view_reducer_assign(view_reducer_assign({}, state), { pagesCount: action.payload });
        default:
            return state;
    }
};
...
const react_router_dom_excluded = ["onClick", "reloadDocument", "replace", "state", "target", "to"],
      react_router_dom_excluded2 = ["aria-current", "caseSensitive", "className", "end", "style", "to", "children"];
...
var api_actions_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var getPosts = function () {
    return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return api_actions_generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_default().get(GET_POSTS_URL)];
                case 1:
                    response = _a.sent();
                    return [3 /*break*/, 3];
                case 2:
...
;// CONCATENATED MODULE: ./src/components/posts/search/search.tsx
...
var Search = function () {
    ...
    var posts = useSelector(function (state) { return state.data.posts; });
...
;// CONCATENATED MODULE: ./src/components/posts/table/table.tsx
...
var Table = function () {
    ...
    var navigate = react_router_useNavigate();
    var posts = useSelector(function (state) { return state.data.posts; });
    var searchedPosts = useSelector(function (state) { return state.data.searchedPosts; });
    (0,react.useEffect)(function () {
        setSortMode(null);
    }, [posts, searchedPosts]);
    ...
    return (react.createElement("table", { className: "table" },
        react.createElement("thead", null,
            react.createElement("tr", { className: "table__header-row" },
                react.createElement("th", { className: "table__header table__header--id" },
                    react.createElement("button", { className: "table__header-button", onClick: function () { return onSortButtonClick(SortMode.ID); } }, "ID")),
                react.createElement("th", { className: "table__header table__header--title" },
                    react.createElement("button", { className: "table__header-button", onClick: function () { return onSortButtonClick(SortMode.TITLE); } }, "\u0417\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A")),
                react.createElement("th", { className: "table__header table__header--description" },
                    react.createElement("button", { className: "table__header-button", onClick: function () { return onSortButtonClick(SortMode.BODY); } }, "\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435")))),
        react.createElement("tbody", null,
            displayedPosts.map(function (post, i) {
                return react.createElement("tr", { key: i, className: "table__row" },
                    react.createElement("td", { className: "table__cell" }, post.id),
                    react.createElement("td", { className: "table__cell" }, post.title),
                    react.createElement("td", { className: "table__cell" }, post.body));
            }),
            emptyRows
                ? emptyRows.map(function (post, i) {
                    return react.createElement("tr", { key: i, className: "table__row" },
                        react.createElement("td", { className: "table__cell" }),
                        react.createElement("td", { className: "table__cell" }),
                        react.createElement("td", { className: "table__cell" }));
                })
                : null)));
...
;// CONCATENATED MODULE: ./src/components/posts/controls/controls.tsx



var Controls = function () {
    var currentPage = +useParams().page;
    var pagesCount = useSelector(function (state) { return state.view.pagesCount; });
    ...
    return (react.createElement("div", { className: "controls" },
        currentPage > 1
            ? react.createElement(NavLink, { to: "/posts/".concat(currentPage - 1), className: "controls__prev-button" }, "\u041D\u0430\u0437\u0430\u0434")
            : react.createElement("span", { className: "controls__next-button disabled" }, "\u041D\u0430\u0437\u0430\u0434"),
        react.createElement("div", { className: "controls__pagination" }, paginationButtons.map(function (el, i) {
            var page = i + 1;
            var isActive = (page === currentPage || pagesCount === 0);
            return react.createElement(NavLink, { to: "/posts/".concat(page), key: i, className: "controls__pagination-button".concat(isActive ? ' active' : '') }, page);
        })),
        currentPage !== pagesCount && pagesCount !== 0
            ? react.createElement(NavLink, { to: "/posts/".concat(currentPage + 1), className: "controls__next-button" }, "\u0412\u043F\u0435\u0440\u0435\u0434")
            : react.createElement("span", { className: "controls__next-button disabled" }, "\u0412\u043F\u0435\u0440\u0435\u0434")));
};
/* harmony default export */ var controls = (Controls);

;// CONCATENATED MODULE: ./src/components/posts/posts.tsx
...
var Posts = function () {
    var status = useSelector(function (state) { return state.state.appStatus; });
    var dispatch = useDispatch();
    (0,react.useEffect)(function () {
        dispatch(getPosts());
    }, []);
    return (react.createElement("div", { className: "posts" },
        react.createElement("h1", { className: "posts__title visually-hidden" }, "\u041F\u043E\u0441\u0442\u044B"),
        status === AppStatus.READY
            ? react.createElement(react.Fragment, null,
                react.createElement("div", { className: "posts__search" },
                    react.createElement(search, null)),
                react.createElement("div", { className: "posts__table" },
                    react.createElement(table, null)),
                react.createElement("div", { className: "posts__controls" },
                    react.createElement(controls, null)))
            : null,
        status === AppStatus.LOADING
            ? react.createElement("p", { className: "posts__loading-message" }, "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430...")
            : null,
        status === AppStatus.ERROR
            ? react.createElement("p", { className: "posts__error-message" }, "\u041F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430 \u043E\u0448\u0438\u0431\u043A\u0430")
            : null));
};
/* harmony default export */ var posts = (Posts);
...
var App = function () {
    return (react.createElement(HashRouter, null,
        react.createElement(Routes, null,
            react.createElement(Route, { path: '/', element: react.createElement(Navigate, { replace: true, to: '/posts/1' }) }),
            react.createElement(Route, { path: '/posts/:page', element: react.createElement(posts, null) }))));
};
